package com.sample.authorization.api.security.jwt;
...
import com.sample.authorization.api.service.UserDetailsImpl;
...
public class JwtUtil {
	...
	public JwtUtil(@Value("${iam.api.jwtSecret}") String jwtSecret, @Value("${iam.api.jwtExpirationMs}") int jwtExpirationMs) {
